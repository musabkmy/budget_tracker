...
import 'package:budget_tracker/features/wallet/wallet_models/wallet_type.dart';
...
List<BudgetHeadCategory> defaultBudgetHeadCategory = [
  BudgetHeadCategory(localizedNames: {enLan: 'Income'}, categoriesId: {}),
  BudgetHeadCategory(localizedNames: {enLan: 'Housing'}, categoriesId: {}),
  BudgetHeadCategory(localizedNames: {enLan: 'Food'}, categoriesId: {}),
  BudgetHeadCategory(localizedNames: {enLan: 'Life Style'}, categoriesId: {}),
  BudgetHeadCategory(localizedNames: {enLan: 'Saving'}, categoriesId: {}),
];
